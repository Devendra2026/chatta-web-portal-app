...
export default function CitizenServices() {
  ...
  return (
    <section
      id="citizen-services"
      className="relative overflow-hidden bg-gradient-to-b from-white via-slate-50 to-slate-100 px-4 py-24 font-sans md:px-8"
    >
          ...
          {services.map((service, index) => {
            return (
              ...
              >
                ...
                <div
                  className={`absolute top-0 right-0 left-0 h-1.5 bg-gradient-to-r ${service.color} opacity-90 transition-opacity group-hover:opacity-100`}
                />
                ...
                <div>
                  ...
                  <div className="mb-4 flex items-center justify-between">
                    <div
                      className={`h-12 w-12 rounded-2xl bg-gradient-to-br ${service.color} flex shrink-0 items-center justify-center text-white shadow-md shadow-slate-400/20 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3`}
                    >
                      {service.icon}
                    </div>
                    <span
      ...
      <AnimatePresence>
        {activeService && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-xs">
            ...
            >
              {/* Modal Header */}
              <div className="flex items-center justify-between bg-gradient-to-r from-slate-900 to-slate-950 px-6 py-4 text-white">
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-center gap-3 border-t border-slate-100 pt-5">
                      ...
                      <button
                        ...
                        className="flex cursor-pointer items-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-amber-600 px-6 py-2.5 text-xs font-bold text-white shadow-lg shadow-orange-500/20 transition-all hover:brightness-110 disabled:opacity-50"
                      >
                        {downloading ? (
                          <>

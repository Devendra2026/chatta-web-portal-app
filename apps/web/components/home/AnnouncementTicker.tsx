...
export default function AnnouncementTicker() {
  ...
  return (
    <div className="relative z-30 flex flex-col items-stretch overflow-hidden border-y border-orange-800 bg-gradient-to-r from-orange-700 via-amber-700 to-orange-800 text-white shadow-md md:flex-row">
      {/* Title Segment */}
      ...
      <div className="relative flex flex-1 items-center overflow-hidden py-2.5 md:py-0">
        <div
          className="animate-marquee flex cursor-pointer items-center gap-16 whitespace-nowrap hover:[animation-play-state:paused]"

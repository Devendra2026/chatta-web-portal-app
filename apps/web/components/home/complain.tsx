...
export default function GrievanceBanner() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-slate-50 px-4 py-16 font-sans md:px-8">
      ...
      <div className="pointer-events-none absolute top-1/2 left-1/2 h-[300px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-600/10 blur-[140px]" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <m.div
          ...
          className="relative overflow-hidden rounded-[2.5rem] border border-blue-500/30 bg-gradient-to-r from-blue-700 via-indigo-700 to-blue-800 p-8 text-white shadow-2xl shadow-blue-900/20 md:p-12"
        >

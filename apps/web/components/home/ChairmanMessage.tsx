...
export default function ChairmanMessage() {
  ...
  return (
    <section
      id="about-us"
      className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-slate-100 px-4 py-24 font-sans md:px-8"
    >
      {/* Background Aesthetic Glows */}
      <div className="pointer-events-none absolute top-10 left-10 h-[500px] w-[500px] rounded-full bg-orange-500/5 blur-[120px]" />
      <div className="pointer-events-none absolute right-10 bottom-10 h-[500px] w-[500px] rounded-full bg-sky-600/5 blur-[120px]" />
        ...
        <div className="grid grid-cols-1 items-stretch gap-8 lg:grid-cols-12">
          ...
          <div className="flex flex-col lg:col-span-4">
            <m.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="group relative flex flex-1 flex-col justify-between overflow-hidden rounded-3xl border border-slate-800 bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 p-6 text-center shadow-2xl"
            >
              {/* Tricolor Accent Top Bar */}
              <div className="absolute top-0 right-0 left-0 h-1.5 bg-gradient-to-r from-orange-500 via-white to-emerald-500" />
              ...
              <div className="relative my-6">
                <div className="relative mx-auto aspect-[4/5] w-full max-w-[240px] overflow-hidden rounded-2xl border-2 border-slate-700/80 bg-slate-800 shadow-xl transition-all duration-500 group-hover:border-orange-500/50">
                  <Image
                    src="/chairman.png"
  ...
  return (
    <button
      ...
      className={`flex cursor-pointer items-center gap-2 rounded-xl px-4 py-2.5 text-xs font-bold tracking-wider uppercase transition-all duration-300 ${
        active
          ? "scale-[1.02] bg-gradient-to-r from-slate-900 to-slate-950 text-white shadow-md shadow-slate-900/10"

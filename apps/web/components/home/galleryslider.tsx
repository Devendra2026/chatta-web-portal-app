...
export default function CertificationsSlider() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 to-slate-100/50 px-4 py-16 md:px-8">
          ...
          <div className="overflow-hidden">
            ...
            >
              {certificationsData.map((cert) => (
                <div
                  key={cert.id}
                  className="min-w-full flex-shrink-0 md:min-w-[calc(33.333%-16px)]"
                >
                  <div
                  ...
                  >
                    ...
                    <div className="relative mb-4 h-64 overflow-hidden rounded-xl border border-slate-100 bg-slate-100">
                      ...
                      />
                      <div className="absolute inset-0 flex items-end bg-gradient-to-t from-slate-900/40 via-transparent to-transparent p-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100">

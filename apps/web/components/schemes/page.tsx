...
export default function Schemes() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-slate-50 px-4 py-24 font-sans text-slate-900 md:px-8">
      ...
      <div className="pointer-events-none absolute top-1/3 left-1/4 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-orange-500/5 blur-[150px]" />
      <div className="pointer-events-none absolute right-1/4 bottom-10 h-[500px] w-[500px] translate-x-1/2 rounded-full bg-blue-500/5 blur-[150px]" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl space-y-16">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {schemes.map((scheme, idx) => (
            ...
            >
              ...
              <div
                className={`absolute top-0 right-0 left-0 h-1 bg-gradient-to-r ${scheme.theme} opacity-80 transition-opacity group-hover:opacity-100`}
              />
        ...
        <div className="flex flex-col items-center justify-between gap-6 rounded-3xl border border-orange-500/30 bg-gradient-to-r from-orange-500/10 via-white to-blue-500/10 p-6 text-slate-900 shadow-2xl backdrop-blur-xl md:flex-row md:p-8">
          ...
          <Link
            href="/contact"
            className="shrink-0 cursor-pointer rounded-2xl bg-gradient-to-r from-orange-500 to-amber-600 px-6 py-3 text-center text-xs font-extrabold tracking-wider text-white uppercase shadow-lg shadow-orange-500/25 transition-all duration-300 hover:scale-105 hover:brightness-110"
          >

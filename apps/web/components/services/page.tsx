...
export default function Services() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute top-1/4 left-0 h-[450px] w-[450px] rounded-full bg-orange-500/5 blur-[140px]"></div>
      <div className="pointer-events-none absolute right-0 bottom-10 h-[450px] w-[450px] rounded-full bg-blue-500/5 blur-[140px]"></div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mx-auto mb-16 max-w-3xl space-y-3 text-center">
          ...
          <div className="mx-auto mt-4 h-1.5 w-24 rounded-full bg-gradient-to-r from-orange-500 to-blue-600"></div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service, index) => (
            ...
            >
              ...
              <div
                className={`absolute top-0 right-0 left-0 h-1 bg-gradient-to-r ${service.themeColor} opacity-80 transition-opacity group-hover:opacity-100`}
              />
              ...
              <div>
                ...
                <div className="mb-5 flex items-center justify-between">
                  <div
                    className={`h-14 w-14 rounded-2xl bg-gradient-to-br ${service.themeColor} flex items-center justify-center text-white shadow-md transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3`}
                  >
                    {service.icon}
                  </div>
      ...
      <AnimatePresence>
        {activeService && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm">
            ...
            >
              {/* Modal Header */}
              <div className="flex items-center justify-between bg-gradient-to-r from-orange-600 to-amber-600 px-6 py-4 text-white">
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-center gap-3 border-t border-slate-100 pt-4">
                      ...
                      <button
                        ...
                        className="flex cursor-pointer items-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-amber-600 px-5 py-2.5 text-xs font-bold text-white shadow-lg shadow-orange-500/25 transition-all hover:brightness-110 disabled:opacity-50"
                      >
                        {downloading ? (
                          <>

    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans selection:bg-orange-500 selection:text-white">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-slate-200/60 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3.5">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-orange-600 to-amber-500 flex items-center justify-center shadow-lg shadow-orange-600/30 ring-4 ring-orange-50">
              <Building2 className="w-6 h-6 text-white" />
            </div>
            <div>
              <span className="text-xs font-bold tracking-wider text-orange-600 uppercase block">Nagar Panchayat Chhata</span>
              <h2 className="text-base sm:text-lg font-extrabold text-slate-900 tracking-tight">Mathura, Uttar Pradesh</h2>
            </div>
          </div>
          
          <div className="hidden sm:flex items-center gap-3 bg-orange-50/60 border border-orange-200/60 px-4 py-2.5 rounded-2xl shadow-sm">
            ...
            <div>
              <h4 className="text-xs font-bold text-slate-900">Secure Gov Portal</h4>
              <p className="text-[10px] text-slate-500 font-medium">Encrypted Tax Gateway</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="relative">
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-orange-500 to-amber-500 rounded-[32px] blur-xl opacity-20 transform scale-[1.01] pointer-events-none"></div>

...
export default function Departments() {
  ...
  return (
    <section
      id="digital-gateway"
      className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-orange-50/20 px-4 py-20 font-sans md:px-8"
    >
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {departments.map((dept, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-x-0 top-0 h-1.5 bg-gradient-to-r ${dept.color}`}
              />
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between">
                  <div
                    className={`h-14 w-14 rounded-2xl bg-gradient-to-br ${dept.color} flex items-center justify-center text-white shadow-lg transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3`}
                  >
                    {dept.icon}
                  </div>
                  <span

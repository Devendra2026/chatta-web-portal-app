...
export default function AboutChhataComplete() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-orange-50/20 font-sans text-slate-800 antialiased selection:bg-orange-600 selection:text-white">
      <div className="mx-auto max-w-6xl space-y-20 px-4 py-12 md:py-20">
        {/* हेडर / हीरो सेक्शन */}
        <header className="relative overflow-hidden rounded-3xl border border-orange-500/20 bg-gradient-to-br from-slate-950 via-slate-900 to-orange-950 p-8 text-center text-white shadow-2xl md:p-16">
        ...
        <main className="grid gap-12 lg:grid-cols-12 lg:items-center">
          ...
          <div className="space-y-6 lg:col-span-7">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <Button
                asChild
                size="lg"
                className="rounded-xl bg-gradient-to-r from-orange-600 to-amber-600 font-bold text-white shadow-lg shadow-orange-500/20 transition-all duration-300 hover:scale-[1.02] hover:from-orange-700 hover:to-amber-700"
              >
                <Link
                  href="#services"
          ...
          <div className="lg:col-span-5">
            <Card className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-white/90 p-6 shadow-2xl shadow-slate-300/40 backdrop-blur-md">
              <div className="absolute inset-x-0 top-0 h-1.5 bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500" />
              ...
              <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                ...
                <span className="rounded-full bg-gradient-to-r from-orange-600 to-amber-600 px-3.5 py-1 text-xs font-bold text-white shadow-sm">
                  15 वार्ड
                </span>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-3.5">
                {/* Population */}
                <div className="col-span-2 flex items-center justify-between rounded-2xl border border-orange-100 bg-gradient-to-r from-orange-50/80 to-amber-50/50 p-4 shadow-sm">
                  <div className="flex items-center gap-3.5">
                    <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-orange-600 to-amber-600 text-white shadow-md shadow-orange-500/20">
                ...
                {/* Literacy Rate */}
                <div className="rounded-2xl border border-emerald-100 bg-gradient-to-b from-emerald-50/60 to-teal-50/30 p-4 shadow-sm">
                  <div className="flex items-center gap-2 text-emerald-700">
                    <GraduationCap className="h-4 w-4" />
                    <span className="text-xs font-extrabold">शिक्षा स्तर</span>
                  </div>
                  <p className="mt-2 bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-2xl font-black text-transparent">
                    उन्नत
                  </p>
                ...
                {/* Households */}
                <div className="rounded-2xl border border-amber-100 bg-gradient-to-b from-amber-50/60 to-orange-50/30 p-4 shadow-sm">
                  <div className="flex items-center gap-2 text-amber-700">
                    <Home className="h-4 w-4" />
                    <span className="text-xs font-extrabold">सुविधाएँ</span>
                  </div>
                  <p className="mt-2 bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-2xl font-black text-transparent">
                    स्मार्ट
                  </p>
                  <p className="mt-1 text-[11px] font-medium text-slate-600">
                    डिजिटल ई-गवर्नेंस
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br ${service.accent} border shadow-inner transition-transform duration-300 group-hover:scale-110`}
                    >
